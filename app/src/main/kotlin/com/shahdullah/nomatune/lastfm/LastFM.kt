...
package com.shahdullah.nomatune.lastfm
...
import com.shahdullah.nomatune.lastfm.models.LastFmError
import com.shahdullah.nomatune.lastfm.models.TokenResponse
import java.net.URI
...
object LastFM {
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        headers.append(HttpHeaders.UserAgent, "Pixel Music (https://github.com/zlgskt6/Pixel-Music)")
        val paramsForSig =
            mutableMapOf(
                "method" to method,
                "api_key" to apiKey,
