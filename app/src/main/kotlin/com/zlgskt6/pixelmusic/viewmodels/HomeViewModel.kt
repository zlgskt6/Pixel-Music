...
import com.zlgskt6.pixelmusic.innertube.utils.hasYouTubeLoginCookie
import com.zlgskt6.pixelmusic.constants.AccountChannelHandleKey
import com.zlgskt6.pixelmusic.constants.AccountEmailKey
import com.zlgskt6.pixelmusic.constants.AccountImageUrlKey
...
import com.zlgskt6.pixelmusic.constants.QuickPicks
import com.zlgskt6.pixelmusic.constants.QuickPicksKey
import com.zlgskt6.pixelmusic.constants.SelectedYtmPlaylistsKey
...
import com.zlgskt6.pixelmusic.db.entities.*
import com.zlgskt6.pixelmusic.extensions.toEnum
import com.zlgskt6.pixelmusic.models.SimilarRecommendation
...
import com.zlgskt6.pixelmusic.utils.SavedAccount
...
class HomeViewModel @Inject constructor(
        ...
        try {
            YouTube.accountInfo().onSuccess { info ->
                ...
                context.dataStore.edit { preferences ->
                    ...
                    preferences[AccountImageUrlKey] = info.thumbnailUrl ?: ""
                }
            }.onFailure { error ->
    ...
    fun loadMoreYouTubeItems(continuation: String?) {
        if (continuation == null || _isLoadingMore.value || isLoading.value) return
        val hideExplicit = context.dataStore.get(HideExplicitKey, false)
        val hideVideo = context.dataStore.get(HideVideoKey, false)
