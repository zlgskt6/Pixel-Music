...
package com.zlgskt6.pixelmusic.storage
...
import com.zlgskt6.pixelmusic.constants.StorageFolderDisplayNameKey
import com.zlgskt6.pixelmusic.constants.StorageFolderIdKey
import com.zlgskt6.pixelmusic.constants.StorageFolderPathKey
import com.zlgskt6.pixelmusic.constants.StorageFolderTreeUriKey
...
private fun File.ensureWritableDirectory(): Boolean =
    runCatching {
        ...
        val probe = File(this, ".pixelmusic-storage-probe")
        probe.writeText("ok")
        probe.delete()
    }.isSuccess
