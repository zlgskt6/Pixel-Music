...
import com.zlgskt6.pixelmusic.ui.component.ChipsRow
...
import com.zlgskt6.pixelmusic.ui.utils.SnapLayoutInfoProvider
...
fun HomeScreen(
    ...
    LaunchedEffect(Unit) {
        snapshotFlow {
            ...
            if (lastVisible != null && total > 5 && lastVisible >= total - 3) {
                total
            } else {
                null
            }
