...
| Canvas service requests | The canvas module sends song and artist names, album IDs, or album URLs to `https://artwork-nomatune.koiiverse.cloud/` and can attach a bearer token. | `canvas/src/main/kotlin/com/shahdullah/nomatune/canvas/PixelMusicCanvas.kt` |
